...
def sendMail(receiver,url):
    ...
    <tr>
        <td align="center">
            ...
            <div align="center">
            <a href="{url}&mode=signup" target="_blank" style="text-decoration:none;display:block;color:#ffffff;background-color:#eb0028;border-radius:4px;width:200px;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:04px;padding-bottom:04px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;text-align:center;word-break:keep-all; height: 35px;" align="left">
